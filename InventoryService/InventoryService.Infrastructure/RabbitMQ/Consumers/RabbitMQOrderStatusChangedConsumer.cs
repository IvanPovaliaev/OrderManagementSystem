...
using InventoryService.Application.Orders.Commands.ChangeOrderStatus;
using InventoryService.Infrastructure.RabbitMQ.Messages;
using MediatR;
...
{
    /// <summary>
    /// Represents a consumer for RabbitMQ change order messages.
    /// </summary>
