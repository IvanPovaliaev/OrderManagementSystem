...
{
    internal class RabbitMQOrderCanceledConsumer : IMessageBrokerOrderCanceledConsumer, IDisposable
    {
        private readonly IOptionsMonitor<RabbitMQOptions> _rabbitMQOptionsMonitor;
        private readonly IConnection _connection;
        private readonly IChannel _channel;

        public RabbitMQOrderCanceledConsumer(IOptionsMonitor<RabbitMQOptions> rabbitMQOptionsMonitor)
        {
